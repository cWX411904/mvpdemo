package com.stkj.mvp.adapter.holder;
...
import com.stkj.mvp.adapter.imp.OnItemLongClickListener;
import com.stkj.mvp.adapter.imp.OnItemTouchListener;


/**
 *
 * ViewHolder的抽象类(是ViewHolderForAbsListView和LQRViewHolderForRecyclerView的同一父类)
 */
public class ViewHolder extends RecyclerView.ViewHolder {
    ...
    public ViewHolder setTextColor(int viewId, String colorId) {
        TextView tv = getView(viewId);
